...
offsetfinder64::offsetfinder64(const char* filename) : _freeKernel(true),__symtab(NULL){
    ...
    loadSegments();
    clean();
    _gPhysBase = _find_gPhysBase();
    _kernel_pmap = _find_kernel_pmap();
    _cpacr_write = _find_cpacr_write();
    _idlesleep_str_loc = _find_idlesleep_str_loc();
    _deepsleep_str_loc = _find_deepsleep_str_loc();
...
loc_t offsetfinder64::_find_release_arm() {
    return memmem("RELEASE_ARM",sizeof("RELEASE_ARM")-1);
}
...
patch offsetfinder64::_find_cs_enforcement_disable_amfi(){
...
patch offsetfinder64::_find_i_can_has_debugger_patch_off(){
...
patch offsetfinder64::_find_amfi_patch_offsets(){
...
patch offsetfinder64::_find_proc_enforce(){
...
patch offsetfinder64::_find_remount_patch_offset(){
...
patch offsetfinder64::_find_lwvm_patch_offsets(){
...
loc_t offsetfinder64::_find_sbops(){
...
patch offsetfinder64::_find_nonceEnabler_patch(){
    if (!haveSymbols()){
...
loc_t offsetfinder64::_find_gPhysBase(){
...
loc_t offsetfinder64::_find_kernel_pmap(){
...
loc_t offsetfinder64::_find_cpacr_write(){
    return memmem("\x40\x10\x18\xD5", 4);
}

loc_t offsetfinder64::_find_idlesleep_str_loc(){
...
loc_t offsetfinder64::_find_deepsleep_str_loc(){
    loc_t entryp = find_entry();
